...
export const metadata: Metadata = {
  ...
  description: `${university.description} Premium DBA with triple accreditation. Explore curriculum, tuition, and apply today.`,
};
  ...
  return (
    <main>
      <PageHero
        ...
        description={`Executive doctorate from ${university.name}. Triple-accredited, research-focused programme for senior leaders.`}
            ...
            <div className="mt-6 grid gap-4">
              <div>
                ...
                <p className="mt-2 text-lg font-semibold text-slate-950">
                  {university.duration?.dba ? `${university.duration.dba.min}-${university.duration.dba.max} months` : "18-36 months"}
                </p>
              </div>
              <div>
                <p className="text-xs font-bold uppercase tracking-[0.12em] text-slate-400">
      ...
      <section className="bg-[#F8FAFC] py-24">
        <div className="container-premium">
          <SectionHeading
            ...
            title="DBA Eligibility at Dunster"
          />
      ...
      <section className="bg-white py-24">
        <div className="container-premium">
          <SectionHeading
            ...
            description="Key focus areas and modules in Dunster's DBA programme."
          />
          <div className="mt-14 grid gap-4 max-w-3xl">
