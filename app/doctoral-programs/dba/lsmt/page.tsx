...
const university = getUniversityById("lsmt")!;
const dbaDetails = university.dbaDetails!;

export const metadata: Metadata = {
  title: `${university.name} - Doctor of Business Administration (DBA)`,
  description: `${university.description} Flexible DBA for executives. Explore curriculum, tuition, and apply today.`,
};
  ...
  return (
    <main>
      <PageHero
        ...
        description={`Executive doctorate from ${university.name}. Online and hybrid delivery for global professionals.`}
      ...
      <section className="bg-white py-24">
        <div className="container-premium">
          <SectionHeading
            ...
            description="Key focus areas and modules in LSMT's DBA programme."
          />
          <div className="mt-14 grid gap-4 max-w-3xl">
