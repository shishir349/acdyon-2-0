...
export const metadata: Metadata = {
  ...
  description: `Explore Kennedy University's DBA programme. American-accredited, flexible delivery, global recognition. Review curriculum, tuition, and apply.`,
};
  ...
  return (
    <main>
      <PageHero
        ...
        description={`Executive doctorate from ${university.name}. Flexible, American-accredited, and designed for working professionals.`}
      ...
      <section className="bg-[#F8FAFC] py-24">
        <div className="container-premium">
          <SectionHeading
            ...
            title="DBA Eligibility at Kennedy University"
          />
      ...
      <section className="bg-white py-24">
        <div className="container-premium">
          <SectionHeading
            ...
            description="Key focus areas and modules in Kennedy's DBA programme."
          />
          <div className="mt-14 grid gap-4 max-w-3xl">
