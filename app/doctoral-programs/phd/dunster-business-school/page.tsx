...
const university = getUniversityById("dunster")!;
const phdDetails = university.phdDetails!;

export const metadata: Metadata = {
  title: `${university.name} - Doctor of Philosophy (PhD)`,
  description: `Explore Dunster Business School's PhD programme. UK-chartered, research-led, triple-accredited. Review supervision and apply.`,
};
  ...
  return (
    <main>
      <PageHero
        ...
        description={`Research doctorate from ${university.name}. Triple-accredited, research-focused, designed for original scholarly contribution.`}
            ...
            <div className="mt-6 grid gap-4">
              <div>
                ...
                <p className="mt-2 text-lg font-semibold text-slate-950">
                  {university.duration?.phd ? `${university.duration.phd.min}-${university.duration.phd.max} months` : "36-60 months"}
                </p>
              </div>
              <div>
                <p className="text-xs font-bold uppercase tracking-[0.12em] text-slate-400">
      ...
      <section className="bg-[#F8FAFC] py-24">
        <div className="container-premium">
          <SectionHeading
            ...
            title="PhD Eligibility at Dunster"
          />
      ...
      <section className="bg-white py-24">
        <div className="container-premium">
          <SectionHeading
            ...
            description="Key focus areas and research modules in Dunster's PhD programme."
          />
          <div className="mt-14 grid gap-4 max-w-3xl">
